...
def call_convert(rlabel1, rlabe12, inputn):
    ...
    if ageVal == 'Human':
        d = float((float(tem) / 15) + random.uniform(0.0, 1.5))
        c = float((float(tem) / 7) + random.uniform(0.9, 1.3))
